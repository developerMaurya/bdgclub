function showListOrder3(list_orders, x) {
  ...
  socket.on("data-server", function (msg) {
    console.log("a............")
    console.log("msg.data[0].game...",msg.data[0].game)
    if (msg.data[0].game != 'wingo') return;
    $(".Loading").fadeIn(0);
    setTimeout(() => {
      let data1 = msg.data[0]; // lấy ra cầu mới nhất
      console.log("set time ....data...",msg.data[0])
  ...
  $.ajax({
      ...
      success: function(response) {
          ...
          console.log("data is from getmyEmerd.....",data)
      ...
      if (firstGame && firstGame.stage === list_orders[0].period) {
        console.log("my loss and profite ....")
          var modal = document.getElementById("myModals");
          modal.style.display = "block";
          var myModalheader = document.getElementById("myModals_header");
          var myModal_result = document.getElementById("myModals_result");
          var lottery_result = document.getElementById("lottery_result");
          var myModal_result_Period = document.getElementById("myModals_result_Period");
          if (firstGame.get == 0) {
  ...
  element_2.textContent = "4";
    ...
    console.log("set time is not working.....")
  });
  ...
  $(".stepper-box .plus").click(function (e) {
    e.preventDefault();
    let color = $(".foot .rights").attr("style").split(":");
  ...
  function selectCss(color, bg, text) {
    ...
    $(".foot .rights").css("background-color", bg);
  }
  ...
  function totalMoney() {
    ...
    $(".foot .rights span:eq(1)").text(total + "");
  }
  
  function alertBox(join, addText) {
    // $(".foot .right").attr("data-join", join);
    $(".foot .rights").attr("data-join", join);
    switch (join) {
      case "x":
  ...
  $(".foot .rights").click(function (e) {
    ...
    console.log("join x money...",join,x,money)
    $(this).addClass("block-click");
    $.ajax({
      type: "POST",
    ...
    setTimeout(() => {
      ...
      $(".stepper-box .digit-box input").val(1);
      $(".amount-box").attr("data-money", "1");
      $(".foot .rights span:eq(1)").text(1000 + "");
      $(".foot .rights").removeClass("block-click");
    }, 500);
  });
    ...
    function cownDownTimer() {
      ...
      setInterval(function() {
        ...
        if (seconds1 == 0 && seconds2 == 0) {
          var event = new CustomEvent('alertTriggered');
