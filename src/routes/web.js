...
const initWebRouter = (app) => {
    ...
    router.get('/trx', middlewareController, winGoController.trxPage1);
    ...
    router.get('/trxWingo1', dailyController.trxwingo);
    // BET K5D
    ...
    router.get('/admin/manager/trx', adminController.middlewareAdminController, adminController.trxAdminPage);
